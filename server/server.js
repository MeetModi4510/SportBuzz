...
app.use(cors({
    origin: function (origin, callback) {
        ...
        if (allowedOrigins.indexOf(origin) !== -1 || origin.startsWith('http://localhost') || origin.startsWith('http://127.0.0.1') || origin.includes('10.19.33.75') || origin.includes('ngrok')) {
            callback(null, true);
        } else {
