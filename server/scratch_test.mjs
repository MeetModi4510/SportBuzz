...
fetch('https://stats.espncricinfo.com/ci/engine/stats/index.html?class=1;filter=advanced;ground=292;orderby=start;orderbyad=reverse;template=results;type=team;view=match')
.then(res => res.text())
.then(html => {
