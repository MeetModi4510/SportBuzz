        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              <SportIcon sport="cricket" size={20} className="text-blue-500" />
              <h2 className="text-lg md:text-xl font-bold tracking-tight text-foreground flex items-center gap-2">
                Cricket <span className="text-primary">News</span>
              </h2>
            </div>
              ...
              {marqueeData.map((news, index) => (
                <div 
                  ...
                  className={cn(
                    ...
                    "group relative p-5 rounded-2xl border bg-card/40 backdrop-blur-sm border-blue-500/20 hover:border-blue-500/40",
                    "hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
                  )}
                >
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-10 rounded-2xl transition-opacity duration-300 pointer-events-none bg-gradient-to-br from-blue-500 to-indigo-500" />

                  <div className="relative z-10 flex flex-col h-full justify-between gap-3 pointer-events-none">
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-blue-500 bg-blue-500/10 px-2 py-0.5 rounded">Update</span>
        ...
        <DialogContent className="sm:max-w-[500px] border-border/50 bg-background/95 backdrop-blur-xl">
          <DialogHeader className="space-y-4">
            <div className="flex items-center justify-between mt-2">
              <SportIcon sport="cricket" size={24} className="text-blue-500" />
