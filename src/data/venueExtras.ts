...
import type { VenueAnalysis, BDFutbolVenueStats } from './venueAnalysisData';
...
export const campNou: VenueAnalysis = {
    ...
    capacity: 62657, sport: "football", established: 1957, nickname: "The Cathedral",
    ...
    stats: {
        ...
        bdfutbolId: "1",
        matchesHosted: 1677,
        architect: "Francesc Mitjans Miró & Josep Soteras Mauri",
        dimensions: "105m x 68m",
        clubs: 205,
        seasons: 67,
        locationCoords: [41.380, 2.122],
        locationText: "Barcelona, Spain",
        homeTeams: [{ name: "FC Barcelona", matches: 0 }],
        finalsPlayed: "Olympics 08/08/1992 Poland 2 - 3 Spain",
