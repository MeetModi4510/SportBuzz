        ...
        <div className="flex flex-col flex-1 dark:bg-[#1a1b1e] bg-[#f8f9fa] rounded-3xl p-6 relative">
          ...
          <div className="relative w-full mx-auto min-h-[380px] flex flex-col justify-center">
            ...
            <div className={\`absolute inset-x-0 transition-opacity duration-500 \${viewMode === 'goal' ? 'opacity-100 z-10 relative' : 'opacity-0 pointer-events-none z-0 absolute'} flex flex-col items-center justify-center\`}>
              ...
              {/* Goal Container */}
              <div className="relative w-full max-w-[500px] aspect-[24/8] flex flex-col justify-end overflow-visible mt-6">
                {/* SVG Goal Netting to match original precisely */}
                  ...
                  return (
                    ...
                    >
                      ...
                      {shot.isGoal ? (
                        ...
                        <div className="w-[14px] h-[14px] rounded-full bg-[#c2768d] border-[1.5px] border-[#c2768d]/60 shadow-sm" />
                      )}
                      
                      {/* Red Highlight Ring perfectly centered on the 16x16 container */}
                      {isActive && (
              ...
              {/* Ground - exactly like original */}
              <div className="w-full h-14 bg-[#2f3136] max-w-[600px] mt-0 z-0" />
            </div>
...
const startTag = '// Advanced 2D Shotmap Pitch Renderer';
...
if (startIdx !== -1 && endIdx !== -1) {
  content = content.substring(0, startIdx) + newComponents + '\n' + content.substring(endIdx);
  ...
  console.log('Replaced ShotMapPitch and MatchDetailCard cleanly!');
} else {
