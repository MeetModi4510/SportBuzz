            ...
            >
              ...
              {filteredShots.map((shot: any, idx: number) => {
                ...
                return (
                  ...
                  >
                    <div className={\`rounded-full \${shot.isGoal ? 'w-[16px] h-[16px] bg-white shadow-[0_0_12px_rgba(255,255,255,1)]' : (isOnTarget ? 'w-[14px] h-[14px] bg-[#c2768d]' : 'w-[14px] h-[14px] bg-transparent border-[2.5px] border-[#c2768d]')}\`}>
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  console.log('Replaced left column perfectly with precise image styling!');
} else {
